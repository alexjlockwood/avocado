...
var matrixToTransform = _transforms.matrixToTransform;
var degRound;
var floatRound;
var transformRound;
/**
...
function definePrecision(data, params) {
    ...
    if (matrixData.length) {
        params.transformPrecision = Math.min(params.transformPrecision, Math.max.apply(Math, matrixData.map(floatDigits)) ||
